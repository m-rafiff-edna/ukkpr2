        ...
        <div class="relative">
            <button type="button" id="notificationBtn" class="p-2 rounded-full text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 relative shadow-lg">
                @if(auth()->user()->role == 'admin' || auth()->user()->role == 'petugas')
                    <!-- Solid red circle icon for admin/petugas -->
                    <svg class="h-6 w-6" viewBox="0 0 24 24" fill="red" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="12" cy="12" r="10" />
                    </svg>
                @else
                    <!-- Default notification icon for other roles -->
                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                    </svg>
                @endif
                                ...
                                <div class="flex items-start">
                                    <div class="flex-shrink-0">
                                        ${notif.type === 'new_booking' ? 
                                            // Bell icon for new booking notifications
