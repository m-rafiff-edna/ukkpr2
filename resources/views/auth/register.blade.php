...
@section('content')
<div class="min-h-screen bg-gray-100 bg-white py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
    <div class="max-w-md w-full">
        ...
        <!-- Register Card -->
        <div class="bg-white bg-gray-50 py-8 px-4 shadow-xl rounded-lg sm:px-10 transform transition-all hover:scale-[1.01]">
            <form method="POST" action="/register" class="space-y-6">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700 text-gray-600">
                        Konfirmasi Password
                    </label>
                    <div class="mt-1">
                ...
                <div class="text-sm text-center">
                    <p class="text-gray-600 text-gray-500">
                        Sudah punya akun?
                        <a href="/login" class="font-medium text-blue-600 hover:text-blue-500 text-blue-600 hover:text-blue-600">
                            Login disini
                        </a>
                    </p>
                    <p class="mt-4 text-xs text-gray-500">
                        Lupa password atau ingin mengganti password? Hubungi admin via WhatsApp:
                        <a href="https://wa.me/6288232024968" target="_blank" class="font-semibold text-green-600 hover:text-green-700">0882-3202-4968</a>
                    </p>
                </div>
            </form>
        </div>
